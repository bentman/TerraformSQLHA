...
Start-Transcript -Path 'c:\BUILD\Logs\00_Install-AdDomain.log'
...
Install-ADDSForest `
    ...
    -LogPath 'C:\BUILD\01_ForestPromo.log' `
...
Disable-WindowsOptionalFeature -Online -FeatureName AzureArcSetup -NoRestart -LogPath 'c:\BUILD\disable-AzureArcSetup.log' -Verbose
